					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App ordens de vendas",
									"targetURL": "#zovism-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zovism-display": {
								"semanticObject": "zovism",
								"action": "display",
								"description": "App ordens de vendas",
								"title": "App ordens de vendas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zovism",
									"url": sap.ui.require.toUrl("zovism")
								}
							}
						}
					}
